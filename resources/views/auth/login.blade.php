          ...
          <form method="POST" action="{{ route('login') }}">
            @csrf
             <label class="mb-10" for="name"for="email">Email* </label>
               <input id="name" class="web form-control @error('email') is-invalid @enderror" type="email" name="email" required autofocus autocomplete="email">
           ...
           @enderror
            ...
            <div class="section-field mb-20">
             <label class="mb-10" for="Password">Password* </label>
               <input id="Password" class="Password form-control @error('password') is-invalid @enderror" type="password" name="password" required autocomplete="current-password">
